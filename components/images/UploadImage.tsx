                ...
                {({
                    ...
                    <Box pt={10} pl={10}>
                        ...
                        {typeImg === "photo" && photo && <Box>
                            <Image src={`http://svetlanamuchnova.art:5000/files/${photo}`} alt={photo} width={"150px"} borderRadius={"1.5rem"} />
                            <Box display={"flex"} mt={3} gap={3}>
                                <Button colorScheme={"red"} onClick={() => onRemove(photo, "photo")}>Удалить</Button>
                            </Box>
                        </Box>}
                        {typeImg === "titleImage" && titleImage && <Box>
                            <Image src={`http://svetlanamuchnova.art:5000/files/${titleImage}`} alt={titleImage} width={"150px"} borderRadius={"1.5rem"} />
                            <Box display={"flex"} mt={3} gap={3}>
                        ...
                        {typeImg === "images" && images && images.map((image, index) => {
                            return (
                                <Box key={index} mt={3}>
                                    <Image src={`http://svetlanamuchnova.art:5000/files/${image}`} alt={image} width={"150px"} borderRadius={"1.5rem"} />
                                    <Box display={"flex"} mt={3} gap={3}>
